...
Для понимания того, какую задачу решает бинарный поиск, приведём какой-нибудь стандартный пример. Представим, что ваш друг загадал число и чем быстрее вы его отгадаете, тем больше мармеладок получите. Друг может отвечать:
> 1) Ваше число, больше чем его
> 2) Ваше число меньше или равно, чем его 

Ваша первая стратегия? *Подразумевается спрашивать подряд.*
...
Какое число на этой картинке загадал наш друг?
...
Сперва найдём от чего оттолкнуться - загаданное число точно больше или равно `1` и точно меньше `1000`. Поставим эти границе на картинке: `1` - синий цвет, `1000` - красный цвет.
...
Предлагаю описать общее решение этой задачи:
